...
//  iTunesSearch
//
//  Created by 何东洲 on 2018/4/26.
//  Copyright © 2018年 何东洲. All rights reserved.
//

#import <Foundation/Foundation.h>
#import <UIKit/UIKit.h>
@interface HDZSpeedy : NSObject
/**
 设置按钮的圆角
 ...
 @return 控件
 */
+(id)hdz_changeControlCircularWith:(id)anyControl AndSetCornerRadius:(NSInteger)radius SetBorderWidth:(NSInteger)width SetBorderColor:(UIColor *)borderColor canMasksToBounds:(BOOL)can;
//
//
///**
// 选取部分数据变色（label）
